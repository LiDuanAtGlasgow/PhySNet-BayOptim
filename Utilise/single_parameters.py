...
mean,std=0.10548888146877289,0.25941577553749084
...
if par.train_mode==5:
    batch_size=32
    kwargs={'num_workers':4,'pin_memory':True} if cuda else {}
    model=torch.load(model_path+'model_white_tablecloth_ldls.pth')
    ...
    denormalized_density=-0.20384261
    denormalized_winds=-0.29197207
